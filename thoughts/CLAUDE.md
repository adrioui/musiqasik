...
This directory contains developer thoughts and notes for the musiqasik repository.
It is managed by the HumanLayer thoughts system and should not be committed to the code repository.

## Structure

- `adrifadilah/` → Your personal notes for this repository (symlink to ~/thoughts/repos/musiqasik/adrifadilah)
- `shared/` → Team-shared notes for this repository (symlink to ~/thoughts/repos/musiqasik/shared)
