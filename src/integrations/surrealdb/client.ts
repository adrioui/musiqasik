...
const isServerless =
  typeof process !== "undefined" && (process.env.VERCEL || process.env.NETLIFY);

const SURREALDB_WS_URL =
  import.meta.env.VITE_SURREALDB_WS_URL ||
  (typeof process !== "undefined" ? process.env.SURREALDB_WS_URL : undefined);
const SURREALDB_HTTP_URL =
  import.meta.env.VITE_SURREALDB_HTTP_URL ||
  (typeof process !== "undefined" ? process.env.SURREALDB_HTTP_URL : undefined);
const SURREALDB_NAMESPACE =
  import.meta.env.VITE_SURREALDB_NAMESPACE ||
  (typeof process !== "undefined"
    ? process.env.SURREALDB_NAMESPACE
    : undefined) ||
  "musiqasik";
const SURREALDB_DATABASE =
  import.meta.env.VITE_SURREALDB_DATABASE ||
  (typeof process !== "undefined"
    ? process.env.SURREALDB_DATABASE
    : undefined) ||
  "main";
const SURREALDB_USER =
  import.meta.env.VITE_SURREALDB_USER ||
  (typeof process !== "undefined" ? process.env.SURREALDB_USER : undefined);
const SURREALDB_PASS =
  import.meta.env.VITE_SURREALDB_PASS ||
  (typeof process !== "undefined" ? process.env.SURREALDB_PASS : undefined);
  ...
  Effect.gen(function* () {
    ...
    yield* Effect.tryPromise({
      try: () => db.ready,
        ...
        new DatabaseError({ message: "SurrealDB not ready", cause: error }),
    });
