        ...
        <div className="flex-1 flex flex-col gap-1 min-w-0">
          ...
          <div className="relative w-full h-3 flex items-center group">
            <input
              ...
              aria-label="Seek"
            />
            <div className="w-full h-1 bg-muted rounded-full overflow-hidden relative pointer-events-none peer-focus-visible:ring-2 peer-focus-visible:ring-ring peer-focus-visible:ring-offset-1">
              <div
