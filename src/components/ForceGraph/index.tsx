...
export const ForceGraph = memo(
  forwardRef<ForceGraphHandle, ForceGraphProps>(function ForceGraph(
    {
      nodes,
      edges,
      centerArtist,
    ...
    const nodeSelectionRef = useRef<d3.Selection<
      ...
      unknown
    > | null>(null)
    const containerSelectionRef = useRef<d3.Selection<
      SVGGElement,
      unknown,
      null,
      undefined
    ...
    const lensIndicatorRef = useRef<d3.Selection<
      SVGCircleElement,
      unknown,
      null,
      undefined
