...
describe("useGraphData", () => {
  ...
  it("filters edges below threshold", () => {
    ...
    const edges = [
      createEdge("Artist A", "Artist B", 0.9),
      createEdge("Artist A", "Artist C", 0.3),
    ];
  ...
  it("includes all edges when threshold is 0", () => {
    ...
    const edges = [
      createEdge("Artist A", "Artist B", 0.9),
      createEdge("Artist A", "Artist C", 0.1),
    ];
  ...
  it("only includes nodes that are connected by filtered edges", () => {
    ...
    const edges = [
      createEdge("Artist A", "Artist B", 0.9),
      createEdge("Artist A", "Artist C", 0.7),
    ];
  ...
  it("marks center artist with isCenter flag", () => {
    ...
    const centerNode = result.current.filteredNodes.find(
      (n) => n.name === "Artist A",
    );
    const otherNode = result.current.filteredNodes.find(
      (n) => n.name === "Artist B",
    );
